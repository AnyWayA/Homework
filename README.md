...
3. Слепой аукцион в репозитории "blind-auction".

### Day 10. Return and the calculator.
1. Написать функцию, которая отредактирует регистр имени и фамилии таким образом, чтобы первые бувы были заглавными, а остальные остальные прописными
2. Написать функцию которая выведет количество дней в выбранном месяце, в зависимости от високосного или нет года
3. Программа-калькулятор в репозитории "calculator".
